...
module.exports = client = async (client, mek) => {
  try {
    ...
    const fvn = {
      key: {
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6289643739077-1629979709@g.us" } : {}),
      },
      message: {
        audioMessage: {
    ...
    const fgclink = {
      ...
      message: {
        groupInviteMessage: {
          groupJid: "6283803284713-1629979709@g.us",
          inviteCode: "GOeqQ6MVE7w6nojL1WbWaY",
          groupName: "YakkoXCode•BOT",
          caption: fake,
          jpegThumbnail: thumb,
        },
      },
    ...
    const fvideo = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6283803284713-1629979709@g.us" } : {}),
      },
      message: {
        videoMessage: {
          title: fake,
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "YakkoXCode•06❤️", //Kasih namalu
            description: "SELF BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "YakkoXCode",
            productImageCount: 1,
          },
    ...
    switch (command) {
      case "yakko":
        var yakko = `${ucapanWaktu} @${senderr.split("@")[0]}
...
`;
        sendButImage(from, yakko, "Jangan lupa follow ig @yakkoxcode", thumb, [
          {
        ...
        break;
        case "dana":
        return reply("NO DANA : 081266701766");
        break
      case "pulsa":
      return reply("TSEL : 0812-6670-1766\n\nXL : 0819-4940-0586\n\nIndosat : 085835150434");
      case "owner":
        sendKontak(from, owner, "YakkoXCode", "Sibuk");
        break;
      //------------------< Sticker Cmd >-------------------
case "addcmd":
      case "setcmd":
      if (mek.key.fromMe) return reply(mess.only.owner)
        ...
        break;
      case "delcmd":
        if (!isQuotedSticker && !mek.key.fromMe) return reply("Khusus Owner !!!");
      ...
      case "autojoin":
        if (!mek.key.fromMe) return reply(mess.key.owner);
        if (args[0] == "on") {
...
`.trim();
      ...
      case "kick":
        ...
        if (!isBotGroupAdmins) return reply("Jadikan BOT Sebagai Admin Jika Ingin Menggunakan Fitur Ini!!!");
        if (
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "get":
        ...
        break;
      case "kontag":
        if (!mek.key.fromMe) return reply("YakkoXCode");
        pe = args.join("");
        entah = pe.split("|")[0];
        nah = pe.split("|")[1];
      ...
      case "fdeface":
        ...
        break;
      case "public":
        if (!mek.key.fromMe) return fakestatus("YakkoXCode");
      ...
      case "igstalk":
        ...
        if (!q) return reply ("Usernamenya Mana Kack? contoh .igstalk yakkoxcode");
      ...
      case "term":
        if (!q) return fakegroup(mess.wrongFormat);
        exec(q, (err, stdout) => {
          if (err) return fakegroup(`YakkoXCode:~ ${err}`);
          if (stdout) {
            fakegroup(stdout);
          }
        });
...
Hai ${pushname}
Saya YakkoXCode•BOT ,Yang Di Buat Untuk Memudahkan Dalam Berbagai Hal\nSilahkan Klik Menu Untuk Melihat Fitur BOT\n\n*Thanks Yang Udah Sewa BOT*
`;
        sendButImage(from, menu, "© By 『YakkoXCode🔹06』", thumb, [
          {
            buttonId: `${prefix}yakko`,
            buttonText: {
        ...
        break;
        case "donasi":
           var donasi = `${ucapanWaktu} ${pushname}

Hai Kack${pushname}
*DONASI UNTUK KELANGSUNGAN HIDUPNYA BOT*:\n\nSilahkan Di Pilih Ingin Donasi Via Apa 😘\n\n*Thanks Yang Udah Mau Donasi*
`;
        sendButImage(from, donasi, "© By 『YakkoXCode🔹06』", thumb, [
          {
            buttonId: `${prefix}pulsa`,
            buttonText: {
              displayText: `💰DONASI PULSA`,
            },
            type: 1,
          },
          {
